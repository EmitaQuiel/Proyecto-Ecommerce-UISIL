...
let SliderDom = tarjetas_desplegablesDom.querySelector('.tarjetas_desplegables .list');
let miniaturaBorderDom = document.querySelector('.tarjetas_desplegables .miniatura');
...
function showSlider(type){
    let  SliderItemsDom = SliderDom.querySelectorAll('.tarjetas_desplegables .list .item');
    let miniaturaItemsDom = document.querySelectorAll('.tarjetas_desplegables .miniatura .item');
